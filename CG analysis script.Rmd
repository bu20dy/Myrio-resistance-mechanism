...
# data load in
```{r eval=F}
setwd("C:/Users/Admin/OneDrive - Montana State University/USACE/PDS project")
...
```{r}
# average
ggplot(garden1, aes(x=Genotype, y=log2(average_fc), color=Treatment)) +
  geom_boxplot() +
  scale_y_continuous(limits=c(-3,3)) +
  theme_bw() +
  ggtitle("Experiment 1: Growth Room Cattle Tanks") +
  labs(y="Average PDS Fold Change") +
...
```{r}
# average
ggplot(garden3, aes(x=Genotype, y=log2(average_fc), color=Treatment)) +
  geom_boxplot() +
  scale_y_continuous(limits=c(-3,3)) +
  theme_bw() +
  ggtitle("Experiment 3: Greenhouse 2 Pickle Barrels") +
  labs(y="Average PDS Fold Change") +
  geom_hline(yintercept=c(1,-1), linetype="dashed", color="black")

# ranked
ggplot(garden3, aes(x=Genotype, y=log2(ranked_fc), color=Treatment)) +
  geom_boxplot() +
  scale_y_continuous(limits=c(-3,3)) +
  theme_bw() +
  ggtitle("Experiment 1: Greenhouse 2 Pickle Barrels") +
  labs(y="Ranked PDS Fold Change", x="Genotype") +
...
```{r}
# average
ggplot(garden, aes(x=Genotype, y=log2(average_fc), color=Treatment)) +
  geom_boxplot() +
  scale_y_continuous(limits=c(-3,3)) +
  theme_bw() +
  labs(y="Average PDS Fold Change") +
  geom_hline(yintercept=c(1,-1), linetype="dashed", color="black") +
  scale_x_discrete(labels=c("E_MISGP_380","H_MYR_11345","H_MISGP_249"))

# ranked
ggplot(garden, aes(x=Genotype, y=log2(ranked_fc), color=Treatment)) +
  geom_boxplot() +
  scale_y_continuous(limits=c(-3,3)) +
  theme_bw() +
  labs(y="Ranked PDS Fold Change", x="Genotype") +
